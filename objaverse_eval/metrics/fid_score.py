...
#
# This file is a derivative work based on the file 'fid_score.py'
# from the pytorch-fid repository.
...
def calculate_fid(
    ...
    m1, s1 = compute_statistics_of_path(
        path1, model, batch_size, dims, device, num_workers
    )
    m2, s2 = compute_statistics_of_path(
        path2, model, batch_size, dims, device, num_workers
    )
